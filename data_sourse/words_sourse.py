...
wordle_words = np.load('data_sourse/wordle_words.npy',allow_pickle=True)
kaggle_words = np.load('data_sourse/kaggle_words.npy',allow_pickle=True)
wiki_words = np.load('data_sourse/wiki_words.npy',allow_pickle=True)
...
np.save("data_sourse/words.npy",words)
